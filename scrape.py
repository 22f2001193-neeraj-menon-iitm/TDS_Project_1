...
def fetch_users_in_barcelona(min_followers=100):
    """Fetch users in Barcelona with more than `min_followers` followers."""
    users = []
    page = 1
    while True:
        params = {
            "q": f"location:Barcelona followers:>{min_followers}",
            "per_page": 30,
            "page": page
        }
